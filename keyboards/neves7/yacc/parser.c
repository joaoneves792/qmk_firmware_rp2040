...
#endif
#define ParseARG_SDECL  struct Context * context ;
#define ParseARG_PDECL , struct Context * context 
#define ParseARG_PARAM ,context 
#define ParseARG_FETCH  struct Context * context =yypParser->context ;
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */     6,    5,    4,    3,    2,   28,   19,   24,    5,    4,
 /*    10 */     3,    2,   27,    1,    8,   20,   23,   22,    7,    3,
 /*    20 */     2,    9,
};
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    21,   21,   21,   21,   21,   21,   21,   21,   26,   25,
};
...
static const YYCODETYPE yyRuleInfoLhs[] = {
     8,  /* (0) formula ::= expr */
     9,  /* (1) expr ::= expr ADD expr */
     9,  /* (2) expr ::= expr SUB expr */
     9,  /* (3) expr ::= expr MUL expr */
     9,  /* (4) expr ::= expr DIV expr */
     9,  /* (5) expr ::= LPAREN expr RPAREN */
     9,  /* (6) expr ::= LITERAL */
};
